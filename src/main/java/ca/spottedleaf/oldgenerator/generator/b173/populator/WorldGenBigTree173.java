...
public class WorldGenBigTree173 extends WorldGenerator173 {
    ...
    private Block.Getter blockGetter;
    private Block.Setter blockSetter;
        ...
        for (aint1[b0] = aint[b0]; j1 <= i1; ++j1) {
            ...
            while (k1 <= i1) {
                ...
                if (d0 > (double) f) {
                    ...
                    aint1[b2] = aint[b2] + k1;
                    Block l1 = this.blockGetter.getBlock(aint1[0], aint1[1], aint1[2]);

                    if (!l1.isAir() && !BlockConstants.isLeaves(l1)) {
                        ++k1;
                    } else {
                        this.blockSetter.setBlock(aint1[0], aint1[1], aint1[2], l);
                        ++k1;
                    }
                }
            }
    ...
    private void a(int[] aint, int[] aint1, Block i) {
        ...
        if (aint2[b1] != 0) {
            ...
            for (int k = aint2[b1] + b4; j != k; j += b4) {
                ...
                this.blockSetter.setBlock(aint3[0], aint3[1], aint3[2], i);
            }
        }
    }
    ...
    private int a(int[] aint, int[] aint1) {
        ...
        if (aint2[b1] == 0) {
            ...
            for (j = aint2[b1] + b4; i != j; i += b4) {
                ...
                Block k = this.blockGetter.getBlock(aint3[0], aint3[1], aint3[2]);
    ...
    private boolean d() {
        ...
        Block i = this.blockGetter.getBlock(this.pos[0], this.pos[1] - 1, this.pos[2]);
