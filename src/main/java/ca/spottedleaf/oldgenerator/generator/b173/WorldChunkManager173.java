...
public class WorldChunkManager173 {
    ...
    public WorldChunkManager173(long seed) {
        this.e = new NoiseGeneratorOctaves2173(new Random(seed * 9871L), 4);
        this.f = new NoiseGeneratorOctaves2173(new Random(seed * 39811L), 4);
        this.g = new NoiseGeneratorOctaves2173(new Random(seed * 543321L), 2);
    }
