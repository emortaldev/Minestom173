...
public class WorldGenTrees173 extends WorldGenerator173 {

    private final int minHeight;
    private final int maxHeight;
    public WorldGenTrees173(int minHeight, int maxHeight) {
            ...
            if (!flag) {
                ...
                if ((type == Block.GRASS_BLOCK || type == Block.DIRT) && centerY < (maxHeight + 1) - l - 1) {
                        ...
                        for (l1 = centerX - k1; l1 <= centerX + k1; ++l1) {
                            ...
                            for (int k2 = centerZ - k1; k2 <= centerZ + k1; ++k2) {
                                ...
                                if ((Math.abs(j2) != k1 || Math.abs(l2) != k1 || random.nextInt(2) != 0 && j1 != 0) && !LegacyUtil173.Block_o(blockGetter.getBlock(l1, i2, k2))) {
                                    blockSetter.setBlock(l1, i2, k2, Block.OAK_LEAVES);
                                }
                            }
                        }
                    }
                    ...
                    for (i2 = 0; i2 < l; ++i2) {
                        ...
                        if (type.isAir() || BlockConstants.isLeaves(type)) {
                            blockSetter.setBlock(centerX, centerY + i2, centerZ, Block.OAK_LOG);
                        }
                    }
